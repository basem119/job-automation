...
class Settings:
    ...
    def __init__(self, env: Mapping[str, str] | None = None) -> None:
        ...
        self.gmail_address = self._read_optional_setting(merged_env, "GMAIL_ADDRESS")
        self.gmail_app_password = self._read_optional_setting(merged_env, "GMAIL_APP_PASSWORD")
